...
parser.add_argument('--root', default='', metavar='N', type=str,
                    help='data file')
parser.add_argument('--activation', default='', metavar='N', type=str,
                    help='activation function')
parser.add_argument('--optimizer', default='', metavar='N', type=str,
...
class SGDM(torch.optim.SGD):

    def __init__(self, params, lr=0.01, momentum=0.9, dampening=0,
                 weight_decay=0, nesterov=False):
        super(SGDM, self).__init__(params, lr=lr, momentum=momentum,
                                   dampening=dampening, weight_decay=weight_decay,
                                   nesterov=nesterov)


class NAG(torch.optim.SGD):

    def __init__(self, params, lr=0.01, momentum=0.9, dampening=0,
                 weight_decay=0, nesterov=True):
        super(NAG, self).__init__(params, lr=lr, momentum=momentum,
                                  dampening=dampening, weight_decay=weight_decay,
                                  nesterov=nesterov)
...
def train():
    ...
    if args.activation == 'elu':
        from resnet1d_elu import resnet18, resnet34, resnet50, resnet101
    elif args.activation == 'prelu':
        from resnet1d_prelu import resnet18, resnet34, resnet50, resnet101
    elif args.activation == 'lrelu':
        from resnet1d_lrelu import resnet18, resnet34, resnet50, resnet101
    elif args.activation == 'uninit_param':
        from resnet1d_uninit_param import resnet18, resnet34, resnet50, resnet101
    else:
